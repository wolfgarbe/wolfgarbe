 ...
 **SeekStorm OSS**: [Open-source, sub-millisecond vector & lexical search - in-process library & multi-tenancy server, in Rust](https://github.com/SeekStorm/SeekStorm).<br>
